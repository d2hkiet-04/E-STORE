					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="mt-2">
								<div class="row">
									<div class="col-4">
										<label>Suất Xứ</label> <select class="form-select" name="origin">
									...
									<div class="col-4">
										<label>Hãng</label> <select class="form-select" name="brand">
							...
							<div class="mt-2">
								<div class="row">
									<div class="col-6">
										<label>Só Lượng</label> <input type="number" name="quantity"
